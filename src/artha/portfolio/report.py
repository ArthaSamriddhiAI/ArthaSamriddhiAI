...
def generate_report_html(
    ...
    <div class="header">
      ...
      <div class="date">Samriddhi AI Portfolio Operating System</div></div>
    </div>"""
    ...
    <div class="disclaimer">
      <strong>Disclaimer:</strong> This report is generated by Samriddhi AI for informational purposes only. It does not constitute investment advice.
    ...
    <div class="footer">Samriddhi AI | Portfolio Operating System | Evidence-Governance-Accountability | Generated {today_str}</div>
    </body></html>"""
